...
<body style="background:#555" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div class="container" >
        ...
        <div class="child">
                        ...
                        <input type="hidden" name="view" value="<?php if(isset($_GET["view"])){ echo $_GET["view"];} ?>" >
                          <ul>
                            ...
                            <li style="text-align:center;line-height:14px;width:184px;color:#fff;padding-bottom:10px">
                              Entra en modo test para ver como se ha configurado el backing de este clipbloc
                            </li>
                            <li style="font-weight:bold;color:#fff;padding-bottom:10px">
                              user: test
                            </li>
                            <li style="font-weight:bold;color:#fff;padding-bottom:10px">
                              pwd: test
