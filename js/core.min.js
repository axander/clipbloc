...
var waitMsg='Cargando...,Loading...';
showSpinner= function(){
    var sepContent={};
    var content=waitMsg.split(",");
    sepContent["es"]=content[0];
    sepContent["en"]=content[1];
    divWait=document.createElement("div");
    divWait.className="divWait";
    typeof waitContentNew !=='undefined'
    ? divWait.innerHTML="<div class='basicOuter'><div class='basicInner'>"+waitContentNew+"</div></div>"
    : divWait.innerHTML="<div class='basicOuter'><div class='basicInner'><ul><li><img src='./images/spinner.png'/></li><li><span class='es'>"+sepContent['es']+"</span><span class='en'>"+sepContent['en']+"</span></li></ul></div></div>";
                    ...
                    setTimeout(function() {
                        transitionEndFunc = function() {
                            ...
                            endTrans = function() {
                                ...
                                resizeDoc();
                                submenuContainer ? submenuContainer.style.opacity = 1 : null;
                                ...
                                if(typeof fbId !== "undefined" && fbId){
                                    ...
                                    internalNavMenu(fbId.split(",")[0],fbId.split(",")[1]);
                                }
                        ...
                        if (beforeTransitionFunc) {
                            rebuildSubMenu(function(){beforeTransitionFunc(transitionEndFunc);});
                        } else {
                            rebuildSubMenu(function(){transitionEndFunc()});
                        }
                    }, 10);
                }
            });
...
rebuildSubMenu = function(_end){
    submenuContainerHide = true;
    submenuAppHide = true;
    hideSubmenuApp = function(event) {
      ...
      mainContent.style.width = "100%";
      //document.getElementById("htmlContent").className=document.getElementById("htmlContent").className+' blur';
      document.getElementById("mainContainer")
      ?('ontouchstart' in window) || window.DocumentTouch && document instanceof DocumentTouch
        ?document.getElementById("mainContainer").removeEventListener('touchstart', hideSubmenuApp, true )
        :document.getElementById("mainContainer").removeEventListener('click', hideSubmenuApp, true )
      :null;
    };
    showSubmenuApp = function() {
      ...
      document.getElementById("mainContainer")
      ?('ontouchstart' in window) || window.DocumentTouch && document instanceof DocumentTouch
        ?document.getElementById("mainContainer").addEventListener('touchstart', hideSubmenuApp, true )
        :document.getElementById("mainContainer").addEventListener('click', hideSubmenuApp, true)
      :null;
    };
    if (subMenuPB && typeof CONFIG !== "undefined" && typeof CONFIG["closeSubMenuOnSelect"] !== "undefined" && CONFIG["closeSubMenuOnSelect"] === "true" && !document.getElementById("submenuContainer").getAttribute("solid")) {
        submenuContainer.style.opacity = 0;
        if(subMenuPB){
            submenuPBTemp=subMenuPB.cloneNode(true);
            submenuContainer.onclick = function(event) {
                   submenuApphideShow(event);
            };
            document.getElementById("submenuContainer").appendChild(submenuPBTemp);
            submenuContainer = document.getElementById("submenuContainer");
            submenuContainer.setAttribute("solid","1");
            submenuContainer.className = submenuContainer.className + " tempHide";
            setSubMenuScroll();
        }
    }
    if(typeof changeLanguage!=="undefined"){
...
var outerSubMenuOuter;
var intSubMenuOuter ;
var lastSubMenuScroll;
setSubMenuScroll = function(){
    if(!document.getElementById('intSubMenuOuter_'+tabHome) ){
        lastSubMenuScroll? lastSubMenuScroll.style.position= 'absolute': null;
        outerSubMenuOuter = document.createElement('div');
        outerSubMenuOuter.className='outerSubMenuOuter';
        outerSubMenuOuter.id='outerSubMenuOuter_'+tabHome;
        intSubMenuOuter  = document.createElement('div');
        intSubMenuOuter.className='intSubMenuOuter';
        intSubMenuOuter.id='intSubMenuOuter_'+tabHome;
        intSubMenuOuter.appendChild(document.getElementById('homeSection'));
        intSubMenuOuter.appendChild(document.getElementById('menu_level_2'));
        outerSubMenuOuter.appendChild(intSubMenuOuter);
        submenuContainer.appendChild(outerSubMenuOuter);
        lastSubMenuScroll = submenuContainer;
    }
}
var submenuAppHide = true;
var preventShowSubmenu = false;//to prevent show subemnu while internalNav
submenuApphideShow = function() {
    if(preventShowSubmenu){
...
window.onload = function() {
   ...
   setTransitionEnd = function(_elem){
    _elem.addEventListener("transitionend", function(e) {
         if (endTransPage != null) {
             endTransPage();
         }
     }, false);
     _elem.addEventListener('webkitTransitionEnd', function() {
         // the same above
         if (endTransPage != null) {
             endTransPage();
         }
